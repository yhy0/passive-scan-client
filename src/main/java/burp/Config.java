...
public class Config {
    ...
    public static String SUFFIX_REGX = "gif|bmp|js|css|jpeg|jpg|png|pdf|rar|zip|docx|doc|svg|ico|woff|woff2|ttf|otf|jpeg|jpg|mp3|wma|flv|mp4|wmv|ogg|avi|doc|docx|xls|xlsx|ppt|pptx|txt|pdf|zip|exe|tat|ico|css|js|swf|apk|m3u8|ts|ejs|svg|woff|otf";

    // 响应体和响应头匹配字符串
    public static String BLACKLIST_RESP = "非法攻击|非法访问|拦截|X-Powered-By-360wzb|X-dotDefender-denied";
